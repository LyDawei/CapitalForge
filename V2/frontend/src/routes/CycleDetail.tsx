  ...
  return (
    <div>
      ...
      <div className="card">
        ...
        <table>
          <thead><tr><th>Specialist</th><th>Score</th><th>Confidence</th><th>Flags</th><th>Rationale</th></tr></thead>
          <tbody>
      ...
      {c.tradePlan && (
        <div className="card">
          ...
          <div className="grid cols-4">
            ...
            <div><div className="label">Conviction</div><div className="value">{num(c.tradePlan.conviction)}</div></div>
            <div><div className="label">Entry</div><div className="value">{num(c.tradePlan.entry)}</div></div>
            <div><div className="label">Stop</div><div className="value">{num(c.tradePlan.stop)}</div></div>
            <div><div className="label">Target 1</div><div className="value">{num(c.tradePlan.target1)}</div></div>
            <div><div className="label">Target 2</div><div className="value">{num(c.tradePlan.target2)}</div></div>
            <div><div className="label">Risk %</div><div className="value">{num((c.tradePlan.riskPctOfEquity ?? 0) * 100)}%</div></div>
          ...
          {c.tradePlan.outcome && (
            <>
              ...
              <div className="grid cols-3">
                ...
                <div><div className="label">R-multiple</div><div className="value">{num(c.tradePlan.outcome.rMultiple)}</div></div>
              </div>
            </>
          )}
        </div>
